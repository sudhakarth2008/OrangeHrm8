...

{
	...
	{  
		...
		// driver.findElement(By.xpath(OR.password)).sendKeys("admin123");
			 ...
			 driver.findElement(By.xpath(OR.username)).sendKeys(Username);
			 driver.findElement(By.xpath(OR.password)).sendKeys(Password);
		 ...
		 public  void OrangeHRMSigninClick()throws Exception
		 {
			 	...
			 	driver.findElement(By.xpath(OR.login)).click();
