...
public class TestHTMLReporter5 {
	

	
	
	//Html Report Prerequisite settings starts
	public  String HtmlSourceTemplate ="C:\\Users\\Admin\\Desktop\\HTML Report\\HtmlTemplates\\HtmlReport3.html";
	public  String Regression_HtmlSourceTemplate ="C:\\Users\\Admin\\Desktop\\HTML Report\\HtmlTemplates\\HtmlReport5.html";
	public  String Regression_PieGraph126 ="C:\\Users\\Admin\\Desktop\\HTML Report\\HtmlTemplates\\Graph1261.html";
	public  String Regression_columnGraph126 ="C:\\Users\\Admin\\Desktop\\HTML Report\\HtmlTemplates\\Graph1281.html";
	
	public  String ClientLogo ="C:\\Users\\Admin\\Desktop\\HTML Report\\HtmlTemplates\\Logo.JPEG";
	public  String PassIcon  ="C:\\Users\\Admin\\Desktop\\HTML Report\\HtmlTemplates\\passed.ico";
	public  String FailIcon  ="C:\\Users\\Admin\\Desktop\\HTML Report\\HtmlTemplates\\failed.ico";
	
	public  String  canvasjsmin="C:/Users/Admin/Desktop/HTML Report/HtmlTemplates/canvasjs.min.js";
	public static String xlsFile="C://Users//Admin//Desktop//HTML Report//HtmlTemplates//TC05.xls";
	public static String xlsFileSheet="Sheet1";
	
	//Html Report Prerequisite settings Ends
	
	//Program Starts from Below
	public static String HtmlOutputFolder1 ="C:\\Users\\Admin\\Desktop\\HTML Report";
	...
	SimpleDateFormat TestCaseStartDateFormat;
	public String TestCaseStartDateTime;
	Date TestCaseStartDate;
	
	SimpleDateFormat TestCaseEndDateFormat;
	public String TestCaseEndDateTime;
	Date TestCaseEndDate;
	
	long  difference,Duration;
	String  DurationPrint;
	
 public	static String STRTotalDurationinSeconds;
public static	long TotalDurationinSeconds;
		...
		public void HtmlTableHeader(String HtmlOutputFileName,String TestName , String BrowserType) throws Exception
		{
			...
			FileWriter fw = new FileWriter(HtmlOutputFileName,true); 
			  ...
			  TestCaseStartDateFormat = new SimpleDateFormat("dd-MMM-yyyy h:mm:ss:SSS a"); 
			  TestCaseStartDate = new Date();
			  TestCaseStartDateTime = TestCaseStartDateFormat.format(TestCaseStartDate);
			...
			fw.write("\n </table>");
			  ...
			  CellData4=TestCaseStartDateTime;  
...
public static boolean isNullOrEmpty(String str) {
	...
	//	Date TestCaseEndDate;
		 ...
		 TestCaseEndDateFormat = new SimpleDateFormat("dd-MMM-yyyy h:mm:ss:SSS a"); 
		 TestCaseEndDate = new Date();
		 TestCaseEndDateTime = TestCaseEndDateFormat.format(TestCaseEndDate);
	    
		// difference,Duration;
		 
		 difference = TestCaseEndDate.getTime() - TestCaseStartDate.getTime();
	...
	public  synchronized  void PrintmyArray() throws Exception
	{
		...
		cityList.add(TestCaseEndDateTime);
		cityList.add(String.valueOf(Duration));
		cityList.add(String.valueOf(TotalDurationinSeconds));
	...
	//	 System.out.println("Test Name is :"+TestName);
		...
		STRTotalDurationinSeconds=String.valueOf(TotalDurationinSeconds);
		
		fw.write("\n <th width=\"10%\">  " 
			    + " <font size=\"3\" color=\"white\"> <b>Total Duration in Seconds #  "
			    + STRTotalDurationinSeconds
			    + "</b></font>&nbsp      </th>  ");
		...
		fw.write("\n  <th width=\"10%\"><center>Duration Time (Seconds)  </center></th>  ");
		fw.write("\n </tr>");
		    ...
		    //  String CellData1="",CellData2="",CellData3="",CellData4="",CellData5="",CellData6="";
			 ...
			 {	
				...
				// System.out.println("CellData5-"+CellData5);
				 ...
				 TestCaseEndDateTime=eat1.getCellData(xlsFile,xlsFileSheet,i,6);
				 System.out.println("TestCaseEndDateTime :"+TestCaseEndDateTime); //TestCaseEndDateTime
				 
				 DurationPrint=eat1.getCellData(xlsFile,xlsFileSheet,i,7);
				 System.out.println("DurationPrint :"+DurationPrint); //TestCaseEndDateTime
			     //TestCaseEndDateTime
					...
					try
					   {
					       ...
					       row.createCell(6).setCellValue((String) cityList.get(5));//TestCaseEndDateTime
					       row.createCell(7).setCellValue((String) cityList.get(6));//Specific Test Duration
					       row.createCell(8).setCellValue((String) cityList.get(7));//Total all Test Duration
