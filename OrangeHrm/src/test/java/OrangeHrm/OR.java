...
public static String UsersName_Click="//input[@id='searchSystemUser_userName']"; 
public static String Users_Role_Listbox="//select[@id='searchSystemUser_userType']"; 

public static String Epname_Sendkeys="//input[@id='searchSystemUser_employeeName_empName']"; 



public static String Epstatus_Listbox="//select[@id='searchSystemUser_status']"; 
public static String Epsearch_Click="//input[@id='searchBtn']";
public static String Admin_colums="//*[@id='resultTable']/thead/tr/th";
public static String Admin_Rows="//*[@id='resultTable']/tbody/tr/td[2]";
