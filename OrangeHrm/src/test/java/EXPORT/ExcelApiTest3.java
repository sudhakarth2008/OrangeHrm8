   ...
   public FileInputStream fis = null;
    ...
    try {
      ...
      //  eat.CopySheet("hi");
    	...
    	RowCount=eat.getRowCount("E://Batch2Source//Regression2.xls","Sheet1");
    ...
    public void CopyWorkBook(String xlFilePathcurr,String xlFilePathnew) throws Exception
    {
    	...
    	HSSFWorkbook workbookoutput=workbook;
  ...
  //getRow count starts
    		...
    		throws Exception
    {
      ...
      */
       ...
       workbook = new HSSFWorkbook(fis);; //Access the workbook
    ...
    public synchronized void PutCellFormula(String xlFilePath,String sheetName,int rowNum,int column,String Text)throws Exception
    {
